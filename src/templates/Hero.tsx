  ...
  <Background color="bg-custom-amber">
    ...
    <Section yPadding="pt-20 pb-3">
      <HeroOneButton
        ...
        description={
          <div className="flex items-center justify-center">
            <Link href="https://wa.me/523327636068?text=Me%20interesa%20comprar%20Tacos%20Ramiro%20😋">
              <svg
            ...
            <p className="text-4xl text-title-tacos-ramiro sm:text-6xl sm:tracking-tight lg:text-6xl xl:text-[6rem] xl:tracking-tight 2xl:text-[6.5rem]">
              3327636068
            </p>
          </div>
        }
