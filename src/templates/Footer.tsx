  ...
  <Background color="bg-custom-amber">
    <Section>
      <CenteredFooter
        ...
        iconList={
          <>
            <Link href="https://www.facebook.com/share/7xCAMsnP4jbbNsU6/?mibextid=LQQJ4d">
              <svg
            ...
            <Link href="https://www.tiktok.com/@pedritos_tacosdebarbacoa?_t=8nJ7BcQpILV&_r=1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
                width="240px"
        ...
        iconDeliveryAppList={
          <>
            <Link href="https://www.ubereats.com/mx/store/pedritos/Olllk0WTXLmeb0900NsWqg https://www.ubereats.com/mx/store/pedritos/Olllk0WTXLmeb0900NsWqg?utm_source=AdWords_NonBrand&utm_campaign=CM2333179-search-google-nonbrand_113_-99_MX-National_e_all_acq_cpc_es-MX_SMB_DSA_Exact__dsa-2282628345331_665313901840_152222064898__m&campaign_id=20359045112&adg_id=152222064898&fi_id=133202295662&match=&net=g&dev=m&dev_m=&ad_id=665313901840&cre=665313901840&kwid=dsa-2282628345331&kw=&placement=&tar=.&&&&&gclsrc=aw.ds&gad_source=1&gbraid=0AAAAADi-0ChhYoPy1nY2mado7aaksoCes&gclid=EAIaIQobChMItc-j2pjphgMVEtXCBB365Q_jEAAYAiAAEgIyUfD_BwE">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 48 48"
                width="240px"
            ...
            <Link href="https://www.rappi.com.mx/restaurantes/1923494811-pedritos">
              <img
                width="80%"
                src="/assets/images/rappilogo.png"
                alt="Delivery App"
              />
            </Link>
